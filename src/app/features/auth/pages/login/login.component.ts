import { ChangeDetectionStrategy, Component, inject, signal, AfterViewInit, ViewChild, ElementRef, ChangeDetectorRef } from '@angular/core';
...
@Component({
  ...
  template: `
    <section class="auth-shell" #authShell>
