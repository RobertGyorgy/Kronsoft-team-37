...
cafenele_category = {
  ...
  "places": {
    ...
    "la_a_doua": {
      ...
      "description": "Un loc mic și intim, perfect pentru o pauză liniștită cu o cafea bună. Atmosferă calmă, ideal pentru citit, scris sau lucru la laptop.",
      "address": "Centru, Brașov",
...
tree["cafenele"] = cafenele_category

with open(tree_path, "w", encoding="utf-8") as f:
    json.dump(tree, f, indent=2, ensure_ascii=False)

print("[OK] Successfully generated and merged latest Cafenele category into decision_tree.json!")
print(f"Total combinations: {len(cafenele_category['results'])}")
